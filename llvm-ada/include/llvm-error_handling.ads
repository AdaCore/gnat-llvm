...
package LLVM.Error_Handling is
  ...
  --\*===----------------------------------------------------------------------=== 
   ...
   pragma Convention (C, Fatal_Error_Handler_T);  -- llvm-5.0.0.src/include/llvm-c/ErrorHandling.h:21
  ...
  --  
   ...
   procedure Install_Fatal_Error_Handler (Handler : Fatal_Error_Handler_T);  -- llvm-5.0.0.src/include/llvm-c/ErrorHandling.h:30
  ...
  --  
   ...
   procedure Reset_Fatal_Error_Handler;  -- llvm-5.0.0.src/include/llvm-c/ErrorHandling.h:36
  ...
  --  
   ...
   procedure Enable_Pretty_Stack_Trace;  -- llvm-5.0.0.src/include/llvm-c/ErrorHandling.h:43
