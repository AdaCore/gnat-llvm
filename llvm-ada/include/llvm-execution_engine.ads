...
package LLVM.Execution_Engine is
  ...
  --  
   ...
   procedure Link_In_MCJIT;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:37
   pragma Import (C, Link_In_MCJIT, "LLVMLinkInMCJIT");

   procedure Link_In_Interpreter;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:38
   pragma Import (C, Link_In_Interpreter, "LLVMLinkInInterpreter");

   --  skipped empty struct LLVMOpaqueGenericValue

   type Generic_Value_T is new System.Address;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:40

   --  skipped empty struct LLVMOpaqueExecutionEngine

   type Execution_Engine_T is new System.Address;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:41

   --  skipped empty struct LLVMOpaqueMCJITMemoryManager

   type MCJIT_Memory_Manager_T is new System.Address;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:42

   type MCJIT_Compiler_Options_T is record
      OptLevel : aliased unsigned;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:45
      CodeModel : aliased LLVM.Target_Machine.Code_Model_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:46
      NoFramePointerElim : aliased LLVM.Types.Bool_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:47
      EnableFastISel : aliased LLVM.Types.Bool_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:48
      MCJMM : MCJIT_Memory_Manager_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:49
   end record;
   pragma Convention (C_Pass_By_Copy, MCJIT_Compiler_Options_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:44
...
function Create_Generic_Value_Of_Int
   ...
   function Create_Generic_Value_Of_Pointer (P : System.Address) return Generic_Value_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:58
   pragma Import (C, Create_Generic_Value_Of_Pointer, "LLVMCreateGenericValueOfPointer");

   function Create_Generic_Value_Of_Float (Ty : LLVM.Types.Type_T; N : double) return Generic_Value_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:60
   pragma Import (C, Create_Generic_Value_Of_Float, "LLVMCreateGenericValueOfFloat");

   function Generic_Value_Int_Width (Gen_Val_Ref : Generic_Value_T) return unsigned;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:62
   ...
   function Generic_Value_To_Int_C
     (Gen_Val   : Generic_Value_T;
      Is_Signed : LLVM.Types.Bool_T)
      return Extensions.unsigned_long_long;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:64
   pragma Import (C, Generic_Value_To_Int_C, "LLVMGenericValueToInt");

   function Generic_Value_To_Pointer (Gen_Val : Generic_Value_T) return System.Address;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:67
   pragma Import (C, Generic_Value_To_Pointer, "LLVMGenericValueToPointer");

   function Generic_Value_To_Float (Ty_Ref : LLVM.Types.Type_T; Gen_Val : Generic_Value_T) return double;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:69
   pragma Import (C, Generic_Value_To_Float, "LLVMGenericValueToFloat");

   procedure Dispose_Generic_Value (Gen_Val : Generic_Value_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:71
...
function Create_JIT_Compiler_For_Module
   ...
   procedure Initialize_MCJIT_Compiler_Options (Options : access MCJIT_Compiler_Options_T; Size_Of_Options : stddef_h.size_t);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:88
...
function Create_MCJIT_Compiler_For_Module
   ...
   procedure Dispose_Execution_Engine (EE : Execution_Engine_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:113
   pragma Import (C, Dispose_Execution_Engine, "LLVMDisposeExecutionEngine");

   procedure Run_Static_Constructors (EE : Execution_Engine_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:115
   pragma Import (C, Run_Static_Constructors, "LLVMRunStaticConstructors");

   procedure Run_Static_Destructors (EE : Execution_Engine_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:117
   ...
   function Run_Function_As_Main
     (EE : Execution_Engine_T;
      ...
      Env_P : System.Address) return int;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:119
   ...
   function Run_Function
     (EE : Execution_Engine_T;
      F : LLVM.Types.Value_T;
      Num_Args : unsigned;
      Args : System.Address) return Generic_Value_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:123
   pragma Import (C, Run_Function, "LLVMRunFunction");

   procedure Free_Machine_Code_For_Function (EE : Execution_Engine_T; F : LLVM.Types.Value_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:127
   pragma Import (C, Free_Machine_Code_For_Function, "LLVMFreeMachineCodeForFunction");

   procedure Add_Module (EE : Execution_Engine_T; M : LLVM.Types.Module_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:129
...
function Find_Function
   ...
   function Recompile_And_Relink_Function (EE : Execution_Engine_T; Fn : LLVM.Types.Value_T) return System.Address;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:137
   pragma Import (C, Recompile_And_Relink_Function, "LLVMRecompileAndRelinkFunction");

   function Get_Execution_Engine_Target_Data (EE : Execution_Engine_T) return LLVM.Target.Target_Data_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:140
   pragma Import (C, Get_Execution_Engine_Target_Data, "LLVMGetExecutionEngineTargetData");

   function Get_Execution_Engine_Target_Machine (EE : Execution_Engine_T) return LLVM.Target_Machine.Target_Machine_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:142
   ...
   procedure Add_Global_Mapping
     (EE : Execution_Engine_T;
      ...
      Addr : System.Address);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:144
   pragma Import (C, Add_Global_Mapping, "LLVMAddGlobalMapping");

   function Get_Pointer_To_Global (EE : Execution_Engine_T; Global : LLVM.Types.Value_T) return System.Address;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:147
   ...
   function Get_Global_Value_Address_C
     (EE   : Execution_Engine_T;
      Name : Interfaces.C.Strings.chars_ptr)
      return stdint_h.uint64_t;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:149
   ...
   function Get_Function_Address_C
     (EE   : Execution_Engine_T;
      Name : Interfaces.C.Strings.chars_ptr)
      return stdint_h.uint64_t;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:151
  ...
  --===-- Operations on memory managers -------------------------------------=== 
   ...
   pragma Convention (C, Memory_Manager_Allocate_Code_Section_Callback_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:155
   ...
   pragma Convention (C, Memory_Manager_Allocate_Data_Section_Callback_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:158
   ...
   pragma Convention (C, Memory_Manager_Finalize_Memory_Callback_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:161

   type Memory_Manager_Destroy_Callback_T is access procedure  (arg1 : System.Address);
   pragma Convention (C, Memory_Manager_Destroy_Callback_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:163
  ...
  --  
   ...
   function Create_Simple_MCJIT_Memory_Manager
     (Opaque : System.Address;
      ...
      Destroy : Memory_Manager_Destroy_Callback_T) return MCJIT_Memory_Manager_T;  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:176
   pragma Import (C, Create_Simple_MCJIT_Memory_Manager, "LLVMCreateSimpleMCJITMemoryManager");

   procedure Dispose_MCJIT_Memory_Manager (MM : MCJIT_Memory_Manager_T);  -- llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:183
