...
package LLVM.Execution_Engine is
   ...
   function Create_Generic_Value_Of_Int
     (Ty : LLVM.Types.Type_T;
      ...
      Is_Signed : LLVM.Types.Bool_T) return Generic_Value_T;  -- /chelles.b/users/charlet/git/gnat-llvm/llvm-ada/llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:54
   pragma Import (C, Create_Generic_Value_Of_Int, "LLVMCreateGenericValueOfInt");
   ...
   function Generic_Value_To_Int (Gen_Val : Generic_Value_T; Is_Signed : LLVM.Types.Bool_T) return Extensions.unsigned_long_long;  -- /chelles.b/users/charlet/git/gnat-llvm/llvm-ada/llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:64
   pragma Import (C, Generic_Value_To_Int, "LLVMGenericValueToInt");
   ...
   function Create_Execution_Engine_For_Module
     (Out_EE : System.Address;
      ...
      Out_Error : System.Address) return LLVM.Types.Bool_T;  -- /chelles.b/users/charlet/git/gnat-llvm/llvm-ada/llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:75
   pragma Import (C, Create_Execution_Engine_For_Module, "LLVMCreateExecutionEngineForModule");

   function Create_Interpreter_For_Module
     (Out_Interp : System.Address;
      M : LLVM.Types.Module_T;
      Out_Error : System.Address) return LLVM.Types.Bool_T;  -- /chelles.b/users/charlet/git/gnat-llvm/llvm-ada/llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:79
   pragma Import (C, Create_Interpreter_For_Module, "LLVMCreateInterpreterForModule");

   function Create_JIT_Compiler_For_Module
     (Out_JIT : System.Address;
      M : LLVM.Types.Module_T;
      Opt_Level : unsigned;
      Out_Error : System.Address) return LLVM.Types.Bool_T;  -- /chelles.b/users/charlet/git/gnat-llvm/llvm-ada/llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:83
   pragma Import (C, Create_JIT_Compiler_For_Module, "LLVMCreateJITCompilerForModule");
   ...
   function Create_MCJIT_Compiler_For_Module
     (Out_JIT : System.Address;
      ...
      Out_Error : System.Address) return LLVM.Types.Bool_T;  -- /chelles.b/users/charlet/git/gnat-llvm/llvm-ada/llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:108
   pragma Import (C, Create_MCJIT_Compiler_For_Module, "LLVMCreateMCJITCompilerForModule");
   ...
   function Remove_Module
     (EE : Execution_Engine_T;
      ...
      Out_Error : System.Address) return LLVM.Types.Bool_T;  -- /chelles.b/users/charlet/git/gnat-llvm/llvm-ada/llvm-5.0.0.src/include/llvm-c/ExecutionEngine.h:131
   pragma Import (C, Remove_Module, "LLVMRemoveModule");
