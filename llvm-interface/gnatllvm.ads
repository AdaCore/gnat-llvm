...
package GNATLLVM is
   ...
   type Target_C_Type_Info is record
      ...
      Long_Long_Alignment        : Interfaces.C.unsigned;
      Long_Long_Long_Size        : Interfaces.C.unsigned;
      Long_Long_Long_Alignment   : Interfaces.C.unsigned;
      Double_Size                : Interfaces.C.unsigned;
      Double_Alignment           : Interfaces.C.unsigned;
