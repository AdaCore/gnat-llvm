...
package LLVM.Analysis is
  ...
  -- verifier will just return 1  
   ...
   pragma Convention (C, Verifier_Failure_Action_T);  -- llvm-6.0.0.src/include/llvm-c/Analysis.h:39
...
function Verify_Module
  ...
  --   for debugging.  
   ...
   function Verify_Function_C
     (Fn     : LLVM.Types.Value_T;
      Action : Verifier_Failure_Action_T)
      return LLVM.Types.Bool_T;  -- llvm-6.0.0.src/include/llvm-c/Analysis.h:50
   pragma Import (C, Verify_Function_C, "LLVMVerifyFunction");

  -- Open up a ghostview window that displays the CFG of the current function.
  --   Useful for debugging.  

   procedure View_Function_CFG (Fn : LLVM.Types.Value_T);  -- llvm-6.0.0.src/include/llvm-c/Analysis.h:54
   pragma Import (C, View_Function_CFG, "LLVMViewFunctionCFG");

   procedure View_Function_CFG_Only (Fn : LLVM.Types.Value_T);  -- llvm-6.0.0.src/include/llvm-c/Analysis.h:55
