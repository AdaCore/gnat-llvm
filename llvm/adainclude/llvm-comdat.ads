...
package LLVM.Comdat is
  ...
  --/< the same size.
   ...
   pragma Convention (C, Comdat_Selection_Kind_T);  -- llvm-8.0.0.src/include/llvm-c/Comdat.h:33
  ...
  --  
   ...
   function Get_Or_Insert_Comdat_C
     (M    : LLVM.Types.Module_T;
      ...
      return LLVM.Types.Comdat_T;  -- llvm-8.0.0.src/include/llvm-c/Comdat.h:41
  ...
  --  
   ...
   function Get_Comdat (V : LLVM.Types.Value_T) return LLVM.Types.Comdat_T;  -- llvm-8.0.0.src/include/llvm-c/Comdat.h:48
  ...
  --  
   ...
   procedure Set_Comdat (V : LLVM.Types.Value_T; C : LLVM.Types.Comdat_T);  -- llvm-8.0.0.src/include/llvm-c/Comdat.h:55
  ...
  --  
   ...
   function Get_Comdat_Selection_Kind (C : LLVM.Types.Comdat_T) return Comdat_Selection_Kind_T;  -- llvm-8.0.0.src/include/llvm-c/Comdat.h:62
  ...
  --  
   ...
   procedure Set_Comdat_Selection_Kind (C : LLVM.Types.Comdat_T; Kind : Comdat_Selection_Kind_T);  -- llvm-8.0.0.src/include/llvm-c/Comdat.h:69
