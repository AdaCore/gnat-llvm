...
package LLVM.Disassembler is
   ...
   LLVMDisassembler_Option_UseMarkup : constant := 1;  --  llvm-8.0.0.src/include/llvm-c/Disassembler.h:76

   LLVMDisassembler_Option_PrintImmHex : constant := 2;  --  llvm-8.0.0.src/include/llvm-c/Disassembler.h:78

   LLVMDisassembler_Option_AsmPrinterVariant : constant := 4;  --  llvm-8.0.0.src/include/llvm-c/Disassembler.h:80

   LLVMDisassembler_Option_SetInstrComments : constant := 8;  --  llvm-8.0.0.src/include/llvm-c/Disassembler.h:82

   LLVMDisassembler_Option_PrintLatency : constant := 16;  --  llvm-8.0.0.src/include/llvm-c/Disassembler.h:84
...
function Create_Disasm_CPU_Features
  ...
  --  
   ...
   procedure Disasm_Dispose (DC : LLVM.Disassembler_Types.Disasm_Context_T);  -- llvm-8.0.0.src/include/llvm-c/Disassembler.h:89
