...
package LLVM.Execution_Engine is
  ...
  --  
   ...
   type Generic_Value_T is access all Opaque_Generic_Value_Impl_T;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:39

   type Opaque_Execution_Engine_Impl_T is null record;   -- incomplete struct

   type Execution_Engine_T is access all Opaque_Execution_Engine_Impl_T;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:40

   type Opaque_MCJIT_Memory_Manager_Impl_T is null record;   -- incomplete struct

   type MCJIT_Memory_Manager_T is access all Opaque_MCJIT_Memory_Manager_Impl_T;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:41
   ...
   with Convention => C_Pass_By_Copy;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:43
...
function Execution_Engine_Get_Err_Msg
  ...
  --===-- Operations on memory managers -------------------------------------=== 
   ...
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:159
   ...
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:162
   ...
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:165

   type Memory_Manager_Destroy_Callback_T is access procedure (Arg_1 : System.Address)
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/ExecutionEngine.h:167
