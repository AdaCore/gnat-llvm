...
package LLVM.lto is
  ...
  --\*===----------------------------------------------------------------------=== 
   ...
   subtype Bool_T_T is Extensions.bool;  -- llvm-6.0.0.src/include/llvm-c/lto.h:29
  ...
  -- log2 of alignment  
   ...
   SYMBOL_ALIAS : constant Symbol_Attributes_T := 32768;  -- llvm-6.0.0.src/include/llvm-c/lto.h:72
  ...
  --  
   ...
   type Debug_Model_T is 
     (DEBUG_MODEL_NONE,
      DEBUG_MODEL_DWARF);
   pragma Convention (C, Debug_Model_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:80
  ...
  --  
   ...
   pragma Convention (C, Codegen_Model_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:90

  --* opaque reference to a loaded object module  
   --  skipped empty struct LLVMOpaqueLTOModule

   type Module_T_T is new System.Address;  -- llvm-6.0.0.src/include/llvm-c/lto.h:93

  --* opaque reference to a code generator  
   --  skipped empty struct LLVMOpaqueLTOCodeGenerator

   type Code_Gen_T_T is new System.Address;  -- llvm-6.0.0.src/include/llvm-c/lto.h:96

  --* opaque reference to a thin code generator  
   --  skipped empty struct LLVMOpaqueThinLTOCodeGenerator

   type thinlto_code_gen_t is new System.Address;  -- llvm-6.0.0.src/include/llvm-c/lto.h:99
  ...
  --  
   ...
   function Get_Version_C
      return Interfaces.C.Strings.chars_ptr;  -- llvm-6.0.0.src/include/llvm-c/lto.h:111
  ...
  --  
   ...
   function Get_Error_Message_C
      return Interfaces.C.Strings.chars_ptr;  -- llvm-6.0.0.src/include/llvm-c/lto.h:119
  ...
  --  
   ...
   function Module_Is_Object_File_C
     (path : Interfaces.C.Strings.chars_ptr)
      return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:127
  ...
  --  
   ...
   function Module_Is_Object_File_For_Target_C
     (path                 : Interfaces.C.Strings.chars_ptr;
      ...
      return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:135
  ...
  --  
   ...
   function Module_Has_Objc_Category (mem : System.Address; length : stddef_h.size_t) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:145
  ...
  --  
   ...
   function Module_Is_Object_File_In_Memory (mem : System.Address; length : stddef_h.size_t) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:152
...
function Module_Is_Object_File_In_Memory_For_Target
  ...
  --  
   ...
   function Module_Create_C
     (path : Interfaces.C.Strings.chars_ptr)
      return Module_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:171
  ...
  --  
   ...
   function Module_Create_From_Memory (mem : System.Address; length : stddef_h.size_t) return Module_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:180
...
function Module_Create_From_Fd_At_Offset
  ...
  --  
   ...
   procedure Module_Dispose (C_Mod : Module_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:247
  ...
  --  
   ...
   function Module_Get_Target_Triple_C
     (C_Mod : Module_T_T)
      return Interfaces.C.Strings.chars_ptr;  -- llvm-6.0.0.src/include/llvm-c/lto.h:255
  ...
  --  
   ...
   procedure Module_Set_Target_Triple_C
     (C_Mod  : Module_T_T;
      triple : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:263
  ...
  --  
   ...
   function Module_Get_Num_Symbols (C_Mod : Module_T_T) return unsigned;  -- llvm-6.0.0.src/include/llvm-c/lto.h:271
  ...
  --  
   ...
   function Module_Get_Symbol_Name_C
     (C_Mod : Module_T_T;
      index : unsigned)
      return Interfaces.C.Strings.chars_ptr;  -- llvm-6.0.0.src/include/llvm-c/lto.h:279
  ...
  --  
   ...
   function Module_Get_Symbol_Attribute (C_Mod : Module_T_T; index : unsigned) return Symbol_Attributes_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:287
  ...
  --  
   ...
   function Module_Get_Linkeropts_C
     (C_Mod : Module_T_T)
      return Interfaces.C.Strings.chars_ptr;  -- llvm-6.0.0.src/include/llvm-c/lto.h:298
  ...
  -- Added in LTO_API_VERSION=10.
   ...
   DS_NOTE : constant Codegen_Diagnostic_Severity_T_T := 2;  -- llvm-6.0.0.src/include/llvm-c/lto.h:310
  ...
  --  
   ...
   type Diagnostic_Handler_T_T is access procedure 
        (arg1 : Codegen_Diagnostic_Severity_T_T;
         ...
         arg3 : System.Address);
   pragma Convention (C, Diagnostic_Handler_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:321
  ...
  --  
   ...
   procedure Codegen_Set_Diagnostic_Handler
     (arg1 : Code_Gen_T_T;
      ...
      arg3 : System.Address);  -- llvm-6.0.0.src/include/llvm-c/lto.h:331
  ...
  --  
   ...
   function Codegen_Create return Code_Gen_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:345
  ...
  --  
   ...
   function Codegen_Create_In_Local_Context return Code_Gen_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:357
  ...
  --  
   ...
   procedure Codegen_Dispose (arg1 : Code_Gen_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:366
  ...
  --  
   ...
   function Codegen_Add_Module (cg : Code_Gen_T_T; C_Mod : Module_T_T) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:379
  ...
  --  
   ...
   procedure Codegen_Set_Module (cg : Code_Gen_T_T; C_Mod : Module_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:390
  ...
  --  
   ...
   function Codegen_Set_Debug_Model (cg : Code_Gen_T_T; arg2 : Debug_Model_T) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:399
  ...
  --  
   ...
   function Codegen_Set_Pic_Model (cg : Code_Gen_T_T; arg2 : Codegen_Model_T) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:408
  ...
  --  
   ...
   procedure Codegen_Set_Cpu_C
     (cg  : Code_Gen_T_T;
      cpu : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:416
  ...
  --  
   ...
   procedure Codegen_Set_Assembler_Path_C
     (cg   : Code_Gen_T_T;
      path : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:425
  ...
  --  
   ...
   procedure Codegen_Set_Assembler_Args
     (cg : Code_Gen_T_T;
      args : System.Address;
      nargs : int);  -- llvm-6.0.0.src/include/llvm-c/lto.h:433
  ...
  --  
   ...
   procedure Codegen_Add_Must_Preserve_Symbol_C
     (cg     : Code_Gen_T_T;
      symbol : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:444
  ...
  --  
   ...
   function Codegen_Write_Merged_Modules_C
     (cg   : Code_Gen_T_T;
      path : Interfaces.C.Strings.chars_ptr)
      return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:454
  ...
  --  
   ...
   function Codegen_Compile (cg : Code_Gen_T_T; length : access stddef_h.size_t) return System.Address;  -- llvm-6.0.0.src/include/llvm-c/lto.h:469
  ...
  --  
   ...
   function Codegen_Compile_To_File (cg : Code_Gen_T_T; name : System.Address) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:481
  ...
  --  
   ...
   function Codegen_Optimize (cg : Code_Gen_T_T) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:489
  ...
  --  
   ...
   function Codegen_Compile_Optimized (cg : Code_Gen_T_T; length : access stddef_h.size_t) return System.Address;  -- llvm-6.0.0.src/include/llvm-c/lto.h:504
  ...
  --  
   ...
   function Api_Version_Fun return unsigned;  -- llvm-6.0.0.src/include/llvm-c/lto.h:512
  ...
  --  
   ...
   procedure Codegen_Debug_Options_C
     (cg   : Code_Gen_T_T;
      arg2 : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:520
  ...
  --  
   ...
   procedure Initialize_Disassembler;  -- llvm-6.0.0.src/include/llvm-c/lto.h:529
  ...
  --  
   ...
   procedure Codegen_Set_Should_Internalize (cg : Code_Gen_T_T; Should_Internalize : Bool_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:538
  ...
  --  
   ...
   procedure Codegen_Set_Should_Embed_Uselists (cg : Code_Gen_T_T; Should_Embed_Uselists : Bool_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:550
  ...
  --  
   ...
   type bject_Buffer_T is record
      Buffer : Interfaces.C.Strings.chars_ptr;  -- llvm-6.0.0.src/include/llvm-c/lto.h:567
      Size : aliased stddef_h.size_t;  -- llvm-6.0.0.src/include/llvm-c/lto.h:568
   end record;
   pragma Convention (C_Pass_By_Copy, bject_Buffer_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:569
  ...
  --  
   ...
   function thinlto_create_codegen return thinlto_code_gen_t;  -- llvm-6.0.0.src/include/llvm-c/lto.h:583
  ...
  --  
   ...
   procedure thinlto_codegen_dispose (cg : thinlto_code_gen_t);  -- llvm-6.0.0.src/include/llvm-c/lto.h:591
...
procedure thinlto_codegen_add_module
  ...
  --  
   ...
   procedure thinlto_codegen_process (cg : thinlto_code_gen_t);  -- llvm-6.0.0.src/include/llvm-c/lto.h:614
  ...
  --  
   ...
   function thinlto_module_get_num_objects (cg : thinlto_code_gen_t) return unsigned;  -- llvm-6.0.0.src/include/llvm-c/lto.h:625
  ...
  --  
   ...
   function thinlto_module_get_object (cg : thinlto_code_gen_t; index : unsigned) return bject_Buffer_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:636
  ...
  --  
   ...
   function thinlto_module_get_num_object_files (cg : thinlto_code_gen_t) return unsigned;  -- llvm-6.0.0.src/include/llvm-c/lto.h:648
  ...
  --  
   ...
   function thinlto_module_get_object_file_C
     (cg    : thinlto_code_gen_t;
      index : unsigned)
      return Interfaces.C.Strings.chars_ptr;  -- llvm-6.0.0.src/include/llvm-c/lto.h:659
  ...
  --  
   ...
   function thinlto_codegen_set_pic_model (cg : thinlto_code_gen_t; arg2 : Codegen_Model_T) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:668
  ...
  --  
   ...
   procedure thinlto_codegen_set_savetemps_dir_C
     (cg             : thinlto_code_gen_t;
      Save_Temps_Dir : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:678
  ...
  --  
   ...
   procedure thinlto_set_generated_objects_dir_C
     (cg             : thinlto_code_gen_t;
      Save_Temps_Dir : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:689
  ...
  --  
   ...
   procedure thinlto_codegen_set_cpu_C
     (cg  : thinlto_code_gen_t;
      cpu : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:697
  ...
  --  
   ...
   procedure thinlto_codegen_disable_codegen (cg : thinlto_code_gen_t; disable : Bool_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:705
  ...
  --  
   ...
   procedure thinlto_codegen_set_codegen_only (cg : thinlto_code_gen_t; Codegen_Only : Bool_T_T);  -- llvm-6.0.0.src/include/llvm-c/lto.h:713
  ...
  --  
   ...
   procedure thinlto_debug_options (options : System.Address; number : int);  -- llvm-6.0.0.src/include/llvm-c/lto.h:721
  ...
  --  
   ...
   function Module_Is_Thinlto (C_Mod : Module_T_T) return Bool_T_T;  -- llvm-6.0.0.src/include/llvm-c/lto.h:728
...
procedure thinlto_codegen_add_cross_referenced_symbol
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_dir_C
     (cg        : thinlto_code_gen_t;
      Cache_Dir : Interfaces.C.Strings.chars_ptr);  -- llvm-6.0.0.src/include/llvm-c/lto.h:781
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_pruning_interval (cg : thinlto_code_gen_t; interval : int);  -- llvm-6.0.0.src/include/llvm-c/lto.h:791
  ...
  --  
   ...
   procedure thinlto_codegen_set_final_cache_size_relative_to_available_space (cg : thinlto_code_gen_t; percentage : unsigned);  -- llvm-6.0.0.src/include/llvm-c/lto.h:807
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_entry_expiration (cg : thinlto_code_gen_t; expiration : unsigned);  -- llvm-6.0.0.src/include/llvm-c/lto.h:816
