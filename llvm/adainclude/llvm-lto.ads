...
package LLVM.Lto is
   ...
   LTO_API_VERSION : constant := 28;  --  llvm-13.0.0.src/include/llvm-c/lto.h:49
  ...
  --\*===----------------------------------------------------------------------=== 
   ...
   subtype Bool_T_T is Extensions.bool;  -- llvm-13.0.0.src/include/llvm-c/lto.h:31
  ...
  -- log2 of alignment  
   ...
   SYMBOL_ALIAS : constant Symbol_Attributes_T := 32768;  -- llvm-13.0.0.src/include/llvm-c/lto.h:74
  ...
  --  
   ...
   type Debug_Model_T is 
     (DEBUG_MODEL_NONE,
      DEBUG_MODEL_DWARF)
   with Convention => C;  -- llvm-13.0.0.src/include/llvm-c/lto.h:82
  ...
  --  
   ...
   with Convention => C;  -- llvm-13.0.0.src/include/llvm-c/lto.h:92

  --* opaque reference to a loaded object module  
   type LLVMOpaqueLTOModule is null record;   -- incomplete struct

   type Module_T_T is access all LLVMOpaqueLTOModule;  -- llvm-13.0.0.src/include/llvm-c/lto.h:95

  --* opaque reference to a code generator  
   type LLVMOpaqueLTOCodeGenerator is null record;   -- incomplete struct

   type Code_Gen_T_T is access all LLVMOpaqueLTOCodeGenerator;  -- llvm-13.0.0.src/include/llvm-c/lto.h:98

  --* opaque reference to a thin code generator  
   type LLVMOpaqueThinLTOCodeGenerator is null record;   -- incomplete struct

   type thinlto_code_gen_t is access all LLVMOpaqueThinLTOCodeGenerator;  -- llvm-13.0.0.src/include/llvm-c/lto.h:101
...
function Module_Is_Object_File_For_Target
  ...
  --  
   ...
   function Module_Has_Objc_Category (Mem : System.Address; Length : stddef_h.size_t) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:145
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Module_Is_Object_File_In_Memory (Mem : System.Address; Length : stddef_h.size_t) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:152
   with Import => True, 
        Convention => C, 
...
function Module_Create
  ...
  --  
   ...
   function Module_Create_From_Memory (Mem : System.Address; Length : stddef_h.size_t) return Module_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:180
   with Import => True, 
        Convention => C, 
...
function Module_Create_From_Fd_At_Offset
  ...
  --  
   ...
   procedure Module_Dispose (C_Mod : Module_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:247
   with Import => True, 
        Convention => C, 
...
procedure Module_Set_Target_Triple
  ...
  --  
   ...
   function Module_Get_Num_Symbols (C_Mod : Module_T_T) return unsigned  -- llvm-13.0.0.src/include/llvm-c/lto.h:271
   with Import => True, 
        Convention => C, 
...
function Module_Get_Symbol_Name
  ...
  --  
   ...
   function Module_Get_Symbol_Attribute (C_Mod : Module_T_T; Index : unsigned) return Symbol_Attributes_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:287
   with Import => True, 
        Convention => C, 
...
function Module_Get_Linkeropts
  ...
  --  
   ...
   function Module_Get_Macho_Cputype
     (C_Mod : Module_T_T;
      ...
      Out_Cpusubtype : access unsigned) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:311
   with Import => True, 
        Convention => C, 
  ...
  -- Added in LTO_API_VERSION=10.
   ...
   DS_NOTE : constant Codegen_Diagnostic_Severity_T_T := 2;  -- llvm-13.0.0.src/include/llvm-c/lto.h:325
  ...
  --  
   ...
   with Convention => C;  -- llvm-13.0.0.src/include/llvm-c/lto.h:336
  ...
  --  
   ...
   procedure Codegen_Set_Diagnostic_Handler
     (Arg_1 : Code_Gen_T_T;
      ...
      Arg_3 : System.Address)  -- llvm-13.0.0.src/include/llvm-c/lto.h:346
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Create return Code_Gen_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:360
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Create_In_Local_Context return Code_Gen_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:372
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Codegen_Dispose (Arg_1 : Code_Gen_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:381
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Add_Module (Cg : Code_Gen_T_T; C_Mod : Module_T_T) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:394
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Codegen_Set_Module (Cg : Code_Gen_T_T; C_Mod : Module_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:405
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Set_Debug_Model (Cg : Code_Gen_T_T; Arg_2 : Debug_Model_T) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:414
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Set_Pic_Model (Cg : Code_Gen_T_T; Arg_2 : Codegen_Model_T) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:423
   with Import => True, 
        Convention => C, 
...
procedure Codegen_Set_Assembler_Path
  ...
  --  
   ...
   procedure Codegen_Set_Assembler_Args
     (Cg : Code_Gen_T_T;
      Args : System.Address;
      Nargs : int)  -- llvm-13.0.0.src/include/llvm-c/lto.h:448
   with Import => True, 
        Convention => C, 
...
function Codegen_Write_Merged_Modules
  ...
  --  
   ...
   function Codegen_Compile (Cg : Code_Gen_T_T; Length : access stddef_h.size_t) return System.Address  -- llvm-13.0.0.src/include/llvm-c/lto.h:484
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Compile_To_File (Cg : Code_Gen_T_T; Name : System.Address) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:496
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Optimize (Cg : Code_Gen_T_T) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:504
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Codegen_Compile_Optimized (Cg : Code_Gen_T_T; Length : access stddef_h.size_t) return System.Address  -- llvm-13.0.0.src/include/llvm-c/lto.h:519
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Api_Version_Fun return unsigned  -- llvm-13.0.0.src/include/llvm-c/lto.h:527
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Set_Debug_Options (Options : System.Address; Number : int)  -- llvm-13.0.0.src/include/llvm-c/lto.h:541
   with Import => True, 
        Convention => C, 
...
procedure Codegen_Debug_Options
  ...
  --  
   ...
   procedure Codegen_Debug_Options_Array
     (Cg : Code_Gen_T_T;
      ...
      Number : int)  -- llvm-13.0.0.src/include/llvm-c/lto.h:563
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Initialize_Disassembler  -- llvm-13.0.0.src/include/llvm-c/lto.h:573
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Codegen_Set_Should_Internalize (Cg : Code_Gen_T_T; Should_Internalize : Bool_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:582
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Codegen_Set_Should_Embed_Uselists (Cg : Code_Gen_T_T; Should_Embed_Uselists : Bool_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:594
   with Import => True, 
        Convention => C, 
  ...
  --* Opaque reference to an LTO input file  
   ...
   type Input_T_T is access all LLVMOpaqueLTOInput;  -- llvm-13.0.0.src/include/llvm-c/lto.h:598
...
function Input_Create
  ...
  --   
   ...
   procedure Input_Dispose (Input : Input_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:618
   with Import => True, 
        Convention => C, 
  ...
  --   
   ...
   function Input_Get_Num_Dependent_Libraries (Input : Input_T_T) return unsigned  -- llvm-13.0.0.src/include/llvm-c/lto.h:626
   with Import => True, 
        Convention => C, 
...
function Input_Get_Dependent_Library
  ...
  --  
   ...
   function Runtime_Lib_Symbols_List (Size : access stddef_h.size_t) return System.Address  -- llvm-13.0.0.src/include/llvm-c/lto.h:645
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   type Object_Buffer_T is record
      Buffer : Interfaces.C.Strings.chars_ptr;  -- llvm-13.0.0.src/include/llvm-c/lto.h:661
      Size : aliased stddef_h.size_t;  -- llvm-13.0.0.src/include/llvm-c/lto.h:662
   end record
   with Convention => C_Pass_By_Copy;  -- llvm-13.0.0.src/include/llvm-c/lto.h:663
  ...
  --  
   ...
   function thinlto_create_codegen return thinlto_code_gen_t  -- llvm-13.0.0.src/include/llvm-c/lto.h:677
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_codegen_dispose (Cg : thinlto_code_gen_t)  -- llvm-13.0.0.src/include/llvm-c/lto.h:685
   with Import => True, 
        Convention => C, 
...
procedure thinlto_codegen_add_module
  ...
  --  
   ...
   procedure thinlto_codegen_process (Cg : thinlto_code_gen_t)  -- llvm-13.0.0.src/include/llvm-c/lto.h:708
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function thinlto_module_get_num_objects (Cg : thinlto_code_gen_t) return unsigned  -- llvm-13.0.0.src/include/llvm-c/lto.h:719
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function thinlto_module_get_object (Cg : thinlto_code_gen_t; Index : unsigned) return Object_Buffer_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:730
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function thinlto_module_get_num_object_files (Cg : thinlto_code_gen_t) return unsigned  -- llvm-13.0.0.src/include/llvm-c/lto.h:742
   with Import => True, 
        Convention => C, 
...
function thinlto_module_get_object_file
  ...
  --  
   ...
   function thinlto_codegen_set_pic_model (Cg : thinlto_code_gen_t; Arg_2 : Codegen_Model_T) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:762
   with Import => True, 
        Convention => C, 
...
procedure thinlto_codegen_set_cpu
  ...
  --  
   ...
   procedure thinlto_codegen_disable_codegen (Cg : thinlto_code_gen_t; Disable : Bool_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:799
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_codegen_set_codegen_only (Cg : thinlto_code_gen_t; Codegen_Only : Bool_T_T)  -- llvm-13.0.0.src/include/llvm-c/lto.h:807
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_debug_options (Options : System.Address; Number : int)  -- llvm-13.0.0.src/include/llvm-c/lto.h:815
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function Module_Is_Thinlto (C_Mod : Module_T_T) return Bool_T_T  -- llvm-13.0.0.src/include/llvm-c/lto.h:822
   with Import => True, 
        Convention => C, 
...
procedure thinlto_codegen_set_cache_dir
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_pruning_interval (Cg : thinlto_code_gen_t; Interval : int)  -- llvm-13.0.0.src/include/llvm-c/lto.h:885
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_codegen_set_final_cache_size_relative_to_available_space (Cg : thinlto_code_gen_t; Percentage : unsigned)  -- llvm-13.0.0.src/include/llvm-c/lto.h:901
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_entry_expiration (Cg : thinlto_code_gen_t; Expiration : unsigned)  -- llvm-13.0.0.src/include/llvm-c/lto.h:910
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_size_bytes (Cg : thinlto_code_gen_t; Max_Size_Bytes : unsigned)  -- llvm-13.0.0.src/include/llvm-c/lto.h:921
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_size_megabytes (Cg : thinlto_code_gen_t; Max_Size_Megabytes : unsigned)  -- llvm-13.0.0.src/include/llvm-c/lto.h:931
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure thinlto_codegen_set_cache_size_files (Cg : thinlto_code_gen_t; Max_Size_Files : unsigned)  -- llvm-13.0.0.src/include/llvm-c/lto.h:940
   with Import => True, 
        Convention => C, 
