...
package LLVM.Orc_Bindings is
  ...
  --\*===----------------------------------------------------------------------=== 
   ...
   type Orc_JIT_Stack_T is new System.Address;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:33

   subtype Orc_Module_Handle_T is stdint_h.uint64_t;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:34

   subtype Orc_Target_Address_T is stdint_h.uint64_t;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:35
   ...
   pragma Convention (C, Orc_Symbol_Resolver_Fn_T);  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:36

   type Orc_Lazy_Compile_Callback_Fn_T is access function  (arg1 : Orc_JIT_Stack_T; arg2 : System.Address) return stdint_h.uint64_t;
   pragma Convention (C, Orc_Lazy_Compile_Callback_Fn_T);  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:37
  ...
  --  
   ...
   function Orc_Create_Instance (TM : LLVM.Target_Machine.Target_Machine_T) return Orc_JIT_Stack_T;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:49
  ...
  --  
   ...
   function Orc_Get_Error_Msg_C
     (JIT_Stack : Orc_JIT_Stack_T)
      return Interfaces.C.Strings.chars_ptr;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:57
...
procedure Orc_Get_Mangled_Symbol
  ...
  --  
   ...
   procedure Orc_Dispose_Mangled_Symbol_C
     (Mangled_Symbol : Interfaces.C.Strings.chars_ptr);  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:69
  ...
  --  
   ...
   function Orc_Create_Lazy_Compile_Callback
     (JIT_Stack : Orc_JIT_Stack_T;
      ...
      Callback_Ctx : System.Address) return LLVM.Error.Error_T;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:74
...
function Orc_Set_Indirect_Stub_Pointer
  ...
  --  
   ...
   function Orc_Add_Eagerly_Compiled_IR
     (JIT_Stack : Orc_JIT_Stack_T;
      ...
      Symbol_Resolver_Ctx : System.Address) return LLVM.Error.Error_T;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:95
  ...
  --  
   ...
   function Orc_Add_Lazily_Compiled_IR
     (JIT_Stack : Orc_JIT_Stack_T;
      ...
      C_Mod : LLVM.Types.Module_T;
      Symbol_Resolver : Orc_Symbol_Resolver_Fn_T;
      Symbol_Resolver_Ctx : System.Address) return LLVM.Error.Error_T;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:104
  ...
  --  
   ...
   function Orc_Add_Object_File
     (JIT_Stack : Orc_JIT_Stack_T;
      ...
      Symbol_Resolver : Orc_Symbol_Resolver_Fn_T;
      Symbol_Resolver_Ctx : System.Address) return LLVM.Error.Error_T;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:118
  ...
  --  
   ...
   function Orc_Remove_Module (JIT_Stack : Orc_JIT_Stack_T; H : Orc_Module_Handle_T) return LLVM.Error.Error_T;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:130
...
function Orc_Get_Symbol_Address_In
  ...
  --  
   ...
   function Orc_Dispose_Instance (JIT_Stack : Orc_JIT_Stack_T) return LLVM.Error.Error_T;  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:152
  ...
  --  
   ...
   procedure Orc_Register_JIT_Event_Listener (JIT_Stack : Orc_JIT_Stack_T; L : LLVM.Types.JIT_Event_Listener_T);  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:159
  ...
  --  
   ...
   procedure Orc_Unregister_JIT_Event_Listener (JIT_Stack : Orc_JIT_Stack_T; L : LLVM.Types.JIT_Event_Listener_T);  -- llvm-9.0.1.src/include/llvm-c/OrcBindings.h:166
