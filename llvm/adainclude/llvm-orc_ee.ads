...
package LLVM.Orc_EE is
  ...
  --  
   ...
   function Orc_Create_RT_Dyld_Object_Linking_Layer_With_Section_Memory_Manager (ES : LLVM.Orc.Orc_Execution_Session_T) return LLVM.Orc.Orc_Object_Layer_T  -- install/include/llvm-c/OrcEE.h:40
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Orc_RT_Dyld_Object_Linking_Layer_Register_JIT_Event_Listener (RT_Dyld_Obj_Linking_Layer : LLVM.Orc.Orc_Object_Layer_T; Listener : LLVM.Types.JIT_Event_Listener_T)  -- install/include/llvm-c/OrcEE.h:49
   with Import => True, 
        Convention => C, 
