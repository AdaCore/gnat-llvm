...
package LLVM.Target_Machine is
  ...
  --\*===----------------------------------------------------------------------=== 
   ...
   type Target_Machine_T is access all Opaque_Target_Machine_Impl_T;  -- llvm-11.0.1.src/include/llvm-c/TargetMachine.h:28

   type Target_Impl_T is null record;   -- incomplete struct

   type Target_T is access all Target_Impl_T;  -- llvm-11.0.1.src/include/llvm-c/TargetMachine.h:29
   ...
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/TargetMachine.h:36
   ...
   type Reloc_Mode_T is 
     (Reloc_Default,
      ...
      Reloc_RWPI,
      Reloc_ROPI_RWPI)
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/TargetMachine.h:46
   ...
   type Code_Model_T is 
     (Code_Model_Default,
      ...
      Code_Model_Medium,
      Code_Model_Large)
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/TargetMachine.h:56

   type Code_Gen_File_Type_T is 
     (Assembly_File,
      Object_File)
   with Convention => C;  -- llvm-11.0.1.src/include/llvm-c/TargetMachine.h:61
