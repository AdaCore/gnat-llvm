...
package LLVM.Target_Machine is
  ...
  --\*===----------------------------------------------------------------------=== 
   ...
   type Target_Machine_T is access all Opaque_Target_Machine_Impl_T;  -- install/include/llvm-c/TargetMachine.h:28

   type Target_Impl_T is null record;   -- incomplete struct

   type Target_T is access all Target_Impl_T;  -- install/include/llvm-c/TargetMachine.h:29
   ...
   with Convention => C;  -- install/include/llvm-c/TargetMachine.h:36
   ...
   type Reloc_Mode_T is 
     (Reloc_Default,
      ...
      Reloc_RWPI,
      Reloc_ROPI_RWPI)
   with Convention => C;  -- install/include/llvm-c/TargetMachine.h:46
   ...
   type Code_Model_T is 
     (Code_Model_Default,
      ...
      Code_Model_Medium,
      Code_Model_Large)
   with Convention => C;  -- install/include/llvm-c/TargetMachine.h:56

   type Code_Gen_File_Type_T is 
     (Assembly_File,
      Object_File)
   with Convention => C;  -- install/include/llvm-c/TargetMachine.h:61

  --* Returns the first llvm::Target in the registered targets list.  
   function Get_First_Target return Target_T  -- install/include/llvm-c/TargetMachine.h:64
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMGetFirstTarget";

  --* Returns the next llvm::Target given a previous one (or null if there's none)  
   function Get_Next_Target (T : Target_T) return Target_T  -- install/include/llvm-c/TargetMachine.h:66
   with Import => True, 
        Convention => C, 
...
function Create_Target_Machine
  ...
  --  LLVMCreateTargetMachine.  
   ...
   procedure Dispose_Target_Machine (T : Target_Machine_T)  -- install/include/llvm-c/TargetMachine.h:102
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMDisposeTargetMachine";

  --* Returns the Target used in a TargetMachine  
   function Get_Target_Machine_Target (T : Target_Machine_T) return Target_T  -- install/include/llvm-c/TargetMachine.h:105
   with Import => True, 
        Convention => C, 
...
function Get_Target_Machine_Feature_String
  ...
  --* Create a DataLayout based on the targetMachine.  
   function Create_Target_Data_Layout (T : Target_Machine_T) return LLVM.Target.Target_Data_T  -- install/include/llvm-c/TargetMachine.h:123
   with Import => True, 
        Convention => C, 
...
function Get_Host_CPU_Features
  ...
  --* Adds the target-specific analysis passes to the pass manager.  
   procedure Add_Analysis_Passes (T : Target_Machine_T; PM : LLVM.Types.Pass_Manager_T)  -- install/include/llvm-c/TargetMachine.h:157
   with Import => True, 
        Convention => C, 
