...
package LLVM.Transforms_Coroutines is
  ...
  --* See llvm::addCoroutinePassesToExtensionPoints.  
   procedure Pass_Manager_Builder_Add_Coroutine_Passes_To_Extension_Points (PMB : LLVM.Transforms_Pass_Manager_Builder.Pass_Manager_Builder_T)  -- llvm-11.0.1.src/include/llvm-c/Transforms/Coroutines.h:48
   with Import => True, 
        Convention => C, 
