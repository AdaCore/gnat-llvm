...
package LLVM.Transforms_Pass_Manager_Builder is
  ...
  --\*===----------------------------------------------------------------------=== 
   ...
   type Pass_Manager_Builder_T is access all Opaque_Pass_Manager_Builder_Impl_T;  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:20
  ...
  --* See llvm::PassManagerBuilder.  
   function Pass_Manager_Builder_Create return Pass_Manager_Builder_T  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:32
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMPassManagerBuilderCreate";

   procedure Pass_Manager_Builder_Dispose (PMB : Pass_Manager_Builder_T)  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:33
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMPassManagerBuilderDispose";

  --* See llvm::PassManagerBuilder::OptLevel.  
   procedure Pass_Manager_Builder_Set_Opt_Level (PMB : Pass_Manager_Builder_T; Opt_Level : unsigned)  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:37
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMPassManagerBuilderSetOptLevel";

  --* See llvm::PassManagerBuilder::SizeLevel.  
   procedure Pass_Manager_Builder_Set_Size_Level (PMB : Pass_Manager_Builder_T; Size_Level : unsigned)  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:42
   with Import => True, 
        Convention => C, 
...
procedure Pass_Manager_Set_Disable_Simplify_Lib_Calls
  ...
  --* See llvm::PassManagerBuilder::Inliner.  
   procedure Pass_Manager_Builder_Use_Inliner_With_Threshold (PMB : Pass_Manager_Builder_T; Threshold : unsigned)  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:62
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMPassManagerBuilderUseInlinerWithThreshold";

  --* See llvm::PassManagerBuilder::populateFunctionPassManager.  
   procedure Pass_Manager_Builder_Populate_Function_Pass_Manager (PMB : Pass_Manager_Builder_T; PM : LLVM.Types.Pass_Manager_T)  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:67
   with Import => True, 
        Convention => C, 
        External_Name => "LLVMPassManagerBuilderPopulateFunctionPassManager";

  --* See llvm::PassManagerBuilder::populateModulePassManager.  
   procedure Pass_Manager_Builder_Populate_Module_Pass_Manager (PMB : Pass_Manager_Builder_T; PM : LLVM.Types.Pass_Manager_T)  -- llvm-12.0.0.src/include/llvm-c/Transforms/PassManagerBuilder.h:72
   with Import => True, 
        Convention => C, 
