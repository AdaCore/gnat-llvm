...
package Clang.Fatal_Error_Handler is
  ...
  --  
   ...
   procedure Install_Aborting_Llvm_Fatal_Error_Handler  -- llvm-12.0.0.src/tools/clang/include/clang-c/FatalErrorHandler.h:21
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure Uninstall_Llvm_Fatal_Error_Handler  -- llvm-12.0.0.src/tools/clang/include/clang-c/FatalErrorHandler.h:28
   with Import => True, 
        Convention => C, 
